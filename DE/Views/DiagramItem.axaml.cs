...
namespace DE.Views {
    ...
    public partial class DiagramItem: UserControl {
        ...
        public DiagramItem() : this(Array.Empty<MeasuredText>(), Array.Empty<MeasuredText>(), Array.Empty<MeasuredText>(), 0) { }
        ...
        public DiagramItem(MeasuredText[] head, MeasuredText[] attrs, MeasuredText[] meths, object entity) {
            ...
            var grid = this.Find<Grid>("sp_grid") ?? throw new Exception("Чё!?");
